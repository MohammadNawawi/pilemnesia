...
class ModelSimilarMovies {
  ...
  factory ModelSimilarMovies.fromRawJson(String str) =>
      ModelSimilarMovies.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ModelSimilarMovies.fromJson(Map<String, dynamic> json) =>
      ModelSimilarMovies(
