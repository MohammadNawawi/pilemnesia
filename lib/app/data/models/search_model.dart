...
class ModelSearch {
  ...
  factory ModelSearch.fromRawJson(String str) =>
  ...
  factory ModelSearch.fromJson(Map<String, dynamic> json) => ModelSearch(
        ...
        results: json["results"] == null
            ? null
            : List<ModelSearchResult>.from(
                json["results"].map((x) => ModelSearchResult.fromJson(x))),
        totalResults:
...
class ModelSearchResult {
  ...
  factory ModelSearchResult.fromRawJson(String str) =>
      ModelSearchResult.fromJson(json.decode(str));
  ...
  factory ModelSearchResult.fromJson(Map<String, dynamic> json) =>
      ModelSearchResult(
        ...
        knownFor: json["known_for"] == null
            ? null
            : List<ModelSearchKnownFor>.from(
                json["known_for"].map((x) => ModelSearchResult.fromJson(x))),
      );
...
class ModelSearchKnownFor {
  ...
  factory ModelSearchKnownFor.fromRawJson(String str) =>
      ModelSearchKnownFor.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ModelSearchKnownFor.fromJson(Map<String, dynamic> json) =>
      ModelSearchKnownFor(
        posterPath: json["poster_path"] == null ? null : json["poster_path"],
        adult: json["adult"] == null ? null : json["adult"],
        overview: json["overview"] == null ? null : json["overview"],
